-- Supabase Database Migration for Candidate Registrations (Safe Re-run Version)
...
-- Verify table was created (this will show an empty result if table is empty, which is fine)
